    ...
    def _call_openrouter_api(self, prompt: str) -> str:
        ...
        try:
            ...
            data = {
                ...
                "messages": [
                    {"role": "system", "content": "Ты - генератор тестовых вопросов. Твоя задача создавать качественные вопросы с вариантами ответов по заданной теме. Вопросы должны быть на русском языке. Внимательно проверяй, что генерируешь корректный JSON. Всегда завершай каждый объект правильными закрывающими скобками. !!! ВАЖНО: В СВОЕМ ОТВЕТЕ НЕ УКАЗЫВАЙ НИЧЕГО КРОМЕ ВЫХОДНОГО JSON ФАЙЛА !!!"},
