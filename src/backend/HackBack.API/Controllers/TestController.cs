...
namespace HackBack.API.Controllers
{
    ...
    public class TestController(ITestService testService) : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost("/custom")]
        public async Task<IActionResult> CreateCustomTest(CustomTestRequest request, CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        [HttpPost("/generate")]
        public async Task<IActionResult> GenerateTestAsync([FromForm] GenerateTestRequest request, CancellationToken cancellationToken)
        {
