...
namespace HackBack.Infrastructure.Migrations
{
    ...
    [Migration("20250323185812_HzIluhaTamChtotoPomenualAMigratiuNeSdelal")]
    partial class HzIluhaTamChtotoPomenualAMigratiuNeSdelal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HackBack.Domain.Entities.QuestionEntity", b =>
                {
                    ...
                    b.Property<string>("AnswerOptionsSerialized")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("CorrectAnswersSerialized")
                        .IsRequired()
                        .HasColumnType("text");
